...
```
It's a simple system to add a message through REST API then produce it in Apache Kafka and process it in consumer/worker. It can be any time-taking process like saving it data store and performing aggregation or some computation.
```
